...
shinyServer(function(input, output) {
    ...
    # Tranit Data
    output$chart_transit <- renderPlotly({create_line_chart(transit, "% of 2019 Daily Boardings", scales::percent, 1, c('#91268F','#F05A28',"#8CC63E","#00A7A0","#76787A","#BBBDC0"), "variable",100,"%")})
